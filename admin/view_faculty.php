...
<?php
if(isset($_GET['id'])){
	$qry = $conn->query("SELECT faculty_list.*, concat(firstname,' ', lastname) as name, credentials.email FROM faculty_list 
	JOIN credentials ON faculty_list.credentials_id = credentials.credID 
